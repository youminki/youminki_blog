...
- **React 19** - 최신 React 기능과 Concurrent Features 활용
- **TypeScript 5.8** - Strict 모드로 타입 안전성 보장
- **Vite 7** - 초고속 빌드 도구와 HMR
- **Tailwind CSS 4** - 유틸리티 퍼스트 CSS 프레임워크

### **🔧 Development Tools & Quality**

- **ESLint 9** - 최신 ESLint 설정과 TypeScript ESLint 통합
- **Prettier** - 일관된 코드 스타일 자동화
- **TypeScript ESLint** - TypeScript 전용 린팅 규칙
- **React Hooks ESLint Plugin** - React Hooks 규칙 검사
- **React Refresh Plugin** - Vite 개발 환경 최적화

### **🎨 UI/UX & Styling**

- **React Icons** - 다양한 아이콘 라이브러리
- **CSS Variables** - 다크/라이트 테마 시스템
- **Backdrop Filter** - 모던 CSS 효과와 블러 처리
- **Responsive Design** - 모든 디바이스 최적화

### **⚡ Build & Performance**

- **PostCSS** - CSS 후처리 및 최적화
- **Autoprefixer** - CSS 벤더 프리픽스 자동화
- **Rollup** - Vite 빌드 최적화 및 번들링
- **ES2022** - 최신 JavaScript 기능 활용

### **🌐 Deployment & Hosting**

- **Vercel** - 최적화된 배포 플랫폼
- **SPA Routing** - 클라이언트 사이드 라우팅
- **Security Headers** - HSTS 보안 헤더 설정
- **CDN** - 글로벌 콘텐츠 전송 네트워크

### **📱 Modern Web Features**

- **CSS Grid & Flexbox** - 모던 레이아웃 시스템
- **CSS Custom Properties** - 동적 테마 변경
- **Accessibility (a11y)** - 웹 접근성 준수
- **Performance Optimization** - Core Web Vitals 최적화
...
- **🌙 다크/라이트 테마** - CSS Variables 기반 동적 테마 변경
- **📱 반응형 디자인** - 모든 디바이스에서 최적화된 경험
- **⚡ 빠른 개발 환경** - Vite HMR과 TypeScript 지원
- **🔧 코드 품질** - ESLint + Prettier + TypeScript 통합
- **🚀 최적화된 배포** - Vercel CDN과 보안 헤더
...
- **CDN 최적화** - 글로벌 콘텐츠 전송 네트워크
- **보안 헤더** - HSTS 등 보안 설정 자동 적용
...
│   │   ├── Projects.tsx    # 프로젝트 컴포넌트
│   │   ├── Skills.tsx      # 스킬 컴포넌트
│   │   ├── Career.tsx      # 경력 컴포넌트
│   │   ├── School.tsx      # 학력 컴포넌트
│   │   ├── AboutMe.tsx     # 자기소개 컴포넌트
│   │   ├── Footer.tsx      # 푸터 컴포넌트
│   │   └── ThemeToggle.tsx # 테마 토글 컴포넌트
│   ├── contexts/            # React Context
│   │   ├── ThemeContext.ts # 테마 컨텍스트
...
- **테마 시스템**: `src/contexts/ThemeContext.ts`에서 테마 로직을 관리합니다
- **컴포넌트**: `src/components/` 폴더에 재사용 가능한 컴포넌트를 추가하세요
- **스타일링**: Tailwind CSS 클래스를 활용하여 빠른 스타일링을 적용하세요
- **타입 안전성**: TypeScript strict 모드를 활용하여 안전한 코드를 작성하세요
